...
public class HeartiController {
	...
	@RequestMapping(value = "/api/weeklyReport", method = RequestMethod.GET, produces = {MediaType.APPLICATION_JSON_VALUE})
	public ResponseEntity<List<IntervalPrediction>> weeklyReport() throws SQLException {
		try {
			...
			if (weeklypredication == null) {
				return new ResponseEntity<List<IntervalPrediction>>(weeklypredication, HttpStatus.NO_CONTENT);
			} else
	...
	@RequestMapping(value = "/api/intervalReport/{reportType}",method = RequestMethod.GET, produces = {MediaType.APPLICATION_JSON_VALUE})
	public ResponseEntity<List<IntervalPrediction>> intervalReport(@PathVariable String reportType)
		...
		try {
			...
			if (intervalReport == null) {
				return new ResponseEntity<List<IntervalPrediction>>(intervalReport, HttpStatus.NO_CONTENT);
			} else
	...
	@RequestMapping(value = "/api/getTotalCardioArrestPrediction/{memberid}",method = RequestMethod.GET, produces = {MediaType.APPLICATION_JSON_VALUE})
	...
	public ResponseEntity<List<CardioArrestDetection>> getTotalCardioArrestPrediction(@PathVariable String memberid)
		...
		try {
			...
			if (cardioArrestDetections == null) {
				return new ResponseEntity<List<CardioArrestDetection>>(cardioArrestDetections, HttpStatus.NO_CONTENT);
			} else
	...
	@RequestMapping(value = "/api/getTotalCardioArrestPrediction",method = RequestMethod.GET, produces = {MediaType.APPLICATION_JSON_VALUE})
	...
	@RequestMapping(value = "/api/livePredictions/{memberid}",method = RequestMethod.GET, produces = {MediaType.APPLICATION_JSON_VALUE})
	...
	public ResponseEntity<List<LivePrediction>> getLivePrediction(@PathVariable String memberid)
		...
		try {
			...
			if (livePredictions == null) {
				return new ResponseEntity<List<LivePrediction>>(livePredictions, HttpStatus.NO_CONTENT);
			} else
	...
	@RequestMapping(value = "/api/livePredictions",method = RequestMethod.GET, produces = {MediaType.APPLICATION_JSON_VALUE})
	...
	@RequestMapping(value = "/api/getTotalPredictionByPeriod/{interval}",method = RequestMethod.GET, produces = {MediaType.APPLICATION_JSON_VALUE})
	...
	public ResponseEntity<List<GetTotalPredictionByPeriod>> getTotalPredictionByPeriod(@PathVariable String interval)
		...
		try {
			...
			if (getTotalPredictionByPeriods == null) {
				return new ResponseEntity<List<GetTotalPredictionByPeriod>>(getTotalPredictionByPeriods, HttpStatus.NO_CONTENT);
			} else

...
public class HeartInfoRepoImpl  implements HeartInfoRepo{
	...
	public List<IntervalPrediction> monthlyReport() throws HeartiExceptions {
	  ...
	  @Override
	    public List<CardioArrestDetection> totalCardioArrestDetection(String memberid) throws HeartiExceptions {
	...
	@Override
	public List<SymptomPrediction> getChestPainDetection(String memberid)  throws HeartiExceptions {
	...
	@Override
	public List<SymptomPrediction> getBloodPressureDetection(String memberid) throws HeartiExceptions {
		// TODO Auto-generated method stub
		 List<SymptomPrediction> symptomPredictions =new ArrayList<SymptomPrediction>();
	        Connection con=null;
	        try {
	...
	@Override
	public List<SymptomPrediction> getCholesterolDetection(String memberid)  throws HeartiExceptions{
		// TODO Auto-generated method stub
		 List<SymptomPrediction> symptomPredictions =new ArrayList<SymptomPrediction>();
	        Connection con=null;
	        try {
	...
	@Override
	public List<LivePrediction> getLivePrediction(String memberid)  throws HeartiExceptions{
		// TODO Auto-generated method stub
	...
	@Override
	public LivePrediction getLivePredictionBySymptom(String memberid, String symptomType)  throws HeartiExceptions {
		// TODO Auto-generated method stub
	...
	@Override
	public List<GetTotalPredictionByPeriod> getTotaPredictionByPeriod(String interval)  throws HeartiExceptions {
		// TODO Auto-generated method stub
	...
	@Override
	public List<GetTotalPredictionByPeriod> getTotalPredictionByWeekly()  throws HeartiExceptions {
		// TODO Auto-generated method stub
	...
	@Override
	public List<GetTotalPredictionByPeriod> getTotalPredictionByMonthly() throws HeartiExceptions {
		// TODO Auto-generated method stub
		List<GetTotalPredictionByPeriod> totalPredictionByPeriods = new ArrayList<GetTotalPredictionByPeriod>();
		Connection con=null;
	...
	@Override
	public List<GetTotalPredictionByPeriod> getTotalPredictionByYearly()  throws HeartiExceptions {
		// TODO Auto-generated method stub
		List<GetTotalPredictionByPeriod> totalPredictionByPeriods = new ArrayList<GetTotalPredictionByPeriod>();
		Connection con=null;
		int prevPrediction = 1;
	...
	@Override
	public int getPredictionOfChestPainValueByDay(String memberid, int curDay)  throws HeartiExceptions {
		// TODO Auto-generated method stub
		 Connection con=null;
		 int dayPrediction = 0;
	        try {
	...
	@Override
	public int getPredictionOfBloodPressureByDay(String memberid, int curDay)  throws HeartiExceptions{
		// TODO Auto-generated method stub
		 Connection con=null;
		 int dayPrediction = 0;
	        try {
	...
	@Override
	public int getPredictionOfCholesterolByDay(String memberid, int curDay) throws HeartiExceptions {
